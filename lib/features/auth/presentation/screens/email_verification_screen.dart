...
class _ResendButtonState extends State<_ResendButton>
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          // Base background + border (border only in active state)
          Positioned.fill(
            child: Container(
              decoration: BoxDecoration(
                color: isActive
          ...
          // Progress bar — clipped inside border radius
          if (locked)
            Positioned.fill(
              child: ClipRRect(
                borderRadius: AppRadius.smAll,
                ...
                ? FadeTransition(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          _format(widget.cooldown.remainingLock),
                          style: AppTextStyles.labelLarge.copyWith(
                            color: AppColors.secondary,
                            fontWeight: FontWeight.w600,
                          ),
                ...
                : widget.isLoading
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 6),
                          const Icon(Icons.send, size: 14, color: AppColors.info),
                        ],
                      ),
          ),

          // Tap area (somente quando clicável)
